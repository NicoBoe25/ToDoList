...
class ToDo: NSObject {
    ...
    static func loadSampleToDos() -> Array<ToDo>{
        ...
        let todo2:ToDo = ToDo(title: "répondre à Nicolas", state: false, updateDate: Date(), locationEnabled: false, local: nil,photo: nil);
        let todo3:ToDo = ToDo(title: "Réparer la roue", state: false, updateDate: Date(), locationEnabled: false, local: nil,photo: nil);
